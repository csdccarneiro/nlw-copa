...
export function New() {
    ...
    async function handlePoolCreate() {
        ...
        if (!title.trim()) {
            ...
            return showMessage('Informe um nome para o seu bolão', 'red.500')
        ...
        try {
            ...
            showMessage('Bolão criado com sucesso!', 'green.500')
            ...
            showMessage('Não foi possível criar o bolão', 'red.500')
    ...
    return (
        <VStack flex={1} bgColor={"gray.900"}>
            ...
            <VStack mt={8} mx={5} alignItems={"center"}>
                ...
                <Button title={"Criar meu bolão"} mt={4} onPress={handlePoolCreate} isLoading={isLoading} />
